...
internal class JceInputTest {
    ...
    fun testSkippingMap() {
        ...
        assertEquals(
            ...
            jce.load(TestSerializableClassA.serializer(), input)
        )
    }
    ...
    fun testNestedList() {
        ...
        assertEquals(TestSerializableClassA(), jce.load(TestSerializableClassA.serializer(), input))
    }
    ...
    fun testMapStringByteArray() {
        ...
        assertEquals(
            ...
            jce.load(TestSerializableClassA.serializer(), input).toString()
        )
    }
